...
namespace CoStudy.API.Infrastructure.Identity.Services.Implements
{
    public class AccountService : IAccountService
    {
        ...
        public AccountService(
            ...
            IEmailService emailService, IEmailSender emailSender)
        {
            _context = context;
            _mapper = mapper;
        ...
        private void sendVerificationEmail(Account account, string origin)
        {
            ...
            //             {message}"
            //);
            _emailSender.SendEmailAsync(account.Email, "Đăng kí tài khoản", $@"<h4>Verify Email</h4>
                         <p>Thanks for registering!</p>
                         {message}");
        }
        ...
        private void sendAlreadyRegisteredEmail(string email, string origin)
        {
            ...
            _emailSender.SendEmailAsync(email, "Đăng kí tài khoản", $@"<h4>Email Already Registered</h4>
                         <p>Your email <strong>{email}</strong> is already registered.</p>
                         {message}");
        }
